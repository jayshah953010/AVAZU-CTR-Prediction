...
def run_decision_tree():
    ...
    dataset.attribute_types = ['true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true','false']
    ...
    trainSize = int(len(dataset.rows)*.7)
    training_set.rows = []
    test_set.rows = list(dataset.rows)
    while len(training_set.rows) < trainSize:
        index = random.randrange(len(test_set.rows))
        training_set.rows.append(test_set.rows.pop(index)) 
